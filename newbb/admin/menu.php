...
$adminmenu[$i++]['icon'] = "images/menu/synchronization.png";
$adminmenu[$i]['title'] = _MI_NEWBB_ADMENU_ABOUT;
$adminmenu[$i]['link'] = "admin/about.php";
$adminmenu[$i++]['icon'] = "images/menu/about.png";
?>