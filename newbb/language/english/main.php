...
define('_MD_DEL_RELATED','Delete this post and all related posts');
...
define("_MD_DELEDEDMSG","Reason of the deletion<br /><small>(Inform the user about the reason of the deletion)</small>:");
