...
function mypoints_plugin_execute($dirname, $items, $since, $func = 'useritems_count')
{
    ...
    $plugin_info = mypoints_get_plugin_info($dirname , $func) ;
...
function mypoints_get_plugin_info($dirname , $func = 'useritems_count')
{
    global $xoopsConfig;
...
//////
function mypoints_update_points($force = 0)
{
...
// Calculate User Points
            ...
            foreach ($plugins as $plugin) {
                ...
                $count = mypoints_plugin_execute($module->getVar('dirname') , $uid, $since, 'user' . $plugin->getVar('plugintype') . '_count');
                if ($count > 0) {
