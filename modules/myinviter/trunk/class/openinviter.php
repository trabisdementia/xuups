...
class OpenInviter
	...
	public function __construct()
		...
		$this->settings = array('cookie_path'=> dirname(dirname(__FILE__)) . '/cookies',
                                'transport'=>'curl',
	...
	public function startPlugin($plugin_name)
		...
		if (file_exists(dirname(dirname(__FILE__))."/plugins/{$plugin_name}.php"))
			{
			$ok=true;
			if (!class_exists($plugin_name)) include_once(dirname(dirname(__FILE__))."/plugins/{$plugin_name}.php");
