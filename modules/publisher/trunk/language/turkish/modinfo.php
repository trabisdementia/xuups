...
define("_MI_PUB_ADMENU1", "Giriþ");
define("_MI_PUB_ADMENU2", "Kategoriler");
define("_MI_PUB_ADMENU3", "Makaleler");
define("_MI_PUB_ADMENU4", "Ýzinler");
define("_MI_PUB_ADMENU5", "Bloklar ve Gruplar");
define("_MI_PUB_ADMENU6", "Mimetypes");
define("_MI_PUB_ADMENU7", "Modüle Git");

define("_MI_PUB_ADMINHITS", "[ÝÇERÝK SEÇENEKLERÝ] Admin counter reads?");
define("_MI_PUB_ADMINHITSDSC", "Allow admin hits for counter stats?");
define("_MI_PUB_ALLOWSUBMIT", "[ÝZÝNLER] Kullanýcý izinleri");
define("_MI_PUB_ALLOWSUBMITDSC", "Kullanýcýlar siteye makale ekleyebilsin mi?");
define("_MI_PUB_ANONPOST", "[ÝZÝNLER] Ýsimsiz gönderilere izin ver?");
define("_MI_PUB_ANONPOSTDSC", "Allow anonymous users to submit articles?");
define("_MI_PUB_AUTHOR_INFO", "Geliþtiriciler");
define("_MI_PUB_AUTHOR_WORD", "Yazarýn metni");
define("_MI_PUB_AUTOAPP", "[PERMISSIONS] Eklenen makaleler otomatik onaylansýn mý?");
define("_MI_PUB_AUTOAPPDSC", "Yöneticinin müdahelesi olmadan makaleler otomatik olarak eklenebilsin mi?");
define("_MI_PUB_BCRUMB","[YAZDIRMA SEÇENEKLERÝ] Show the module name in the breadcrumb?");
define("_MI_PUB_BCRUMBDSC","Eveti seçerseniz, the breadcrumb will show \"Publisher > kategori adý > makale adý\". <br>aksi halde \"kategori adý > makale adý\" gösterilir.");
define("_MI_PUB_BOTH_FOOTERS","Her iki sayfa alt notu");
define("_MI_PUB_BY", "by");
define("_MI_PUB_CATEGORY_ITEM_NOTIFY", "Kategori öðeleri");
define("_MI_PUB_CATEGORY_ITEM_NOTIFY_DSC", "Bildirme seçeneklerini mevcut kategoriye uygula.");
define("_MI_PUB_CATEGORY_ITEM_PUBLISHED_NOTIFY", "Yeni makale yayýnlandý");
define("_MI_PUB_CATEGORY_ITEM_PUBLISHED_NOTIFY_CAP", "Bu kategoride yeni bir makale yayýnlandýðýnda haber et.");   
define("_MI_PUB_CATEGORY_ITEM_PUBLISHED_NOTIFY_DSC", "Bu kategoride yeni bir makale yayýnlandýðýnda haber et.");      
define("_MI_PUB_CATEGORY_ITEM_PUBLISHED_NOTIFY_SBJ", "[{X_SITENAME}] {X_MODULE} otomatik haber et : Kategoriye yeni bir makale yayýnlandý"); 
define("_MI_PUB_CATEGORY_ITEM_SUBMITTED_NOTIFY", "'Makale eklendi");
define("_MI_PUB_CATEGORY_ITEM_SUBMITTED_NOTIFY_CAP", "Bu kategoride yeni bir makale yayýnlandýðýnda haber et");   
define("_MI_PUB_CATEGORY_ITEM_SUBMITTED_NOTIFY_DSC", "Bu kategoride yeni bir makale yayýnlandýðýnda haber et.");      
define("_MI_PUB_CATEGORY_ITEM_SUBMITTED_NOTIFY_SBJ", "[{X_SITENAME}] {X_MODULE} otomatik haber et : Kategoriye yeni makale eklendi"); 
define("_MI_PUB_CATPERPAGE", "[BÝÇÝM SEÇENEKLERÝ] Sayfada maksimum kategori (User side)?");
...
define("_MI_PUB_COLLHEAD", "[BÝÇÝM SEÇENEKLERÝ] Display the collapsable bar?");
...
define("_MI_PUB_DATEFORMAT", "[BÝÇÝM SEÇENEKLERÝ] Tarih-saat formatý:");
...
define("_MI_PUB_DISCOM", "[ÝÇERÝK SEÇENEKLERÝ] Display comment count?");
define("_MI_PUB_DISCOMDSC", "Set to 'Yes' to display the comments count in the individual article");
define("_MI_PUB_DISDATECOL", "[ÝÇERÝK SEÇENEKLERÝ] 'Yayýnlayan' sütunu görünsün mü?");
...
define("_MI_PUB_DISPLAY_CAT_SUMMARY", "[ÝÇERÝK SEÇENEKLERÝ] Display the category summary?");
...
define("_MI_PUB_DISSBCATDSC", "[ÝÇERÝK SEÇENEKLERÝ] Display sub-categories description?");
define("_MI_PUB_DISSBCATDSCDSC", "Select 'Yes' to display the description of sub-categories in the index and category page.");
define("_MI_PUB_DISTYPE", "[BÝÇÝM SEÇENEKLERÝ] Makalelerin gösterilme þekli:");
...
define("_MI_PUB_FOOTERPRINT","[YAZDIRMA SEÇENEKLERÝ] Print page footer");
...
define("_MI_PUB_HEADERPRINT","[YAZDIRMA SEÇENEKLERÝ] Print page header");
...
define("_MI_PUB_HITSCOL", "[ÝÇERÝK SEÇENEKLERÝ] 'Hitler' sütunu görünsün mü?");
...
define("_MI_PUB_HLCOLOR", "[BÝÇÝM SEÇENEKLERÝ] Highlight color for keywords");
define("_MI_PUB_HLCOLORDSC", "Color of the keywords highligting for the search function");
define("_MI_PUB_IMAGENAV", "[BÝÇÝM SEÇENEKLERÝ] Use the image Page Navigation:");
...
define("_MI_PUB_INDEXFOOTER","[ÝÇERÝK SEÇENEKLERÝ] Index Footer");
...
define("_MI_PUB_INDEXMSG", "[ÝÇERÝK SEÇENEKLERÝ] Giriþ sayfasý hoþ geldiniz mesajý:");
...
define("_MI_PUB_ITEMFOOTER", "[ÝÇERÝK SEÇENEKLERÝ] Item footer");
...
//--/bd
define("_MI_PUB_ITEMSNEW", "Son Öðe Listesi");
define("_MI_PUB_ITEMSPOT", "Popülerite !");
define("_MI_PUB_ITEMSRANDOM_ITEM", "Rasgele Öðe !");
define("_MI_PUB_LASTITEM", "[ÝÇERÝK SEÇENEKLERÝ] Display last item column ?");
define("_MI_PUB_LASTITEMDSC", "Select 'Yes' to display the last item in each category in the index and category page.");
define("_MI_PUB_LASTITEMS", "[ÝÇERÝK SEÇENEKLERÝ] Display the list of newly Yayýnlanmýþ Makaleler?");
define("_MI_PUB_LASTITEMSDSC", "Select 'Yes' to have the list at the bottom of the first page of the module");
define("_MI_PUB_LASTITSIZE", "[BÝÇÝM SEÇENEKLERÝ] Last item size :");
define("_MI_PUB_LASTITSIZEDSC", "Set the maximum size of the title in the Last item column.");
define("_MI_PUB_LINKPATH", "[BÝÇÝM SEÇENEKLERÝ] Enable links on the current path:");
...
define("_MI_PUB_ORDERBY", "[BÝÇÝM SEÇENEKLERÝ] Sýralama Düzeni");
...
define("_MI_PUB_OTHERITEMS", "[BÝÇÝM SEÇENEKLERÝ] Other articles display type");
define("_MI_PUB_OTHERITEMSDSC", "Select how you would like to display the other articles of the category in the article page.");
define("_MI_PUB_PERPAGE", "[BÝÇÝM SEÇENEKLERÝ] Sayfa baþýna gösterilecek maksimummakale adedi (Admin side):");
define("_MI_PUB_PERPAGEDSC", "Maximum number of articles per page to be displayed at once in the admin side.");
define("_MI_PUB_PERPAGEINDEX", "[BÝÇÝM SEÇENEKLERÝ] Maximum articles per page (User side):");
define("_MI_PUB_PERPAGEINDEXDSC", "[YAZDIRMA SEÇENEKLERÝ] Maximum number of articles per page to be displayed together in the user side.");
define("_MI_PUB_PRINTLOGOURL","[YAZDIRMA SEÇENEKLERÝ] 'Yazdýr! logosu URL adresi");
define("_MI_PUB_PRINTLOGOURLDSC","Url of the logo that will be printed at the top of the page");
define("_MI_PUB_RECENTITEMS", "Son Öðeler (Detaylý)");
define("_MI_PUB_SHOW_RSS","[ÝÇERÝK SEÇENEKLERÝ] RSS feed için baðlantýlar görünsün mü");
define("_MI_PUB_SHOW_RSSDSC","");
define("_MI_PUB_SHOW_SUBCATS", "[ÝÇERÝK SEÇENEKLERÝ] Alt Kategori Gösterimi");
define("_MI_PUB_SHOW_SUBCATS_ALL", "Bütün alt kategorileri göster");
...
define("_MI_PUB_SHOW_SUBCATS_NO", "Alt kategorileri gösterme");
...
define("_MI_PUB_SUBMITMSG", "[ÝÇERÝK SEÇENEKLERÝ] Submit page intro message:");
define("_MI_PUB_SUBMITMSGDEF", "");
define("_MI_PUB_SUBMITMSGDSC", "Intro message to be displayed in the submit page of the module.");
define("_MI_PUB_TITLE_SIZE", "[BÝÇÝM SEÇENEKLERÝ] Baþlýk boyutu :");
...
define("_MI_PUB_USEREALNAME", "[BÝÇÝM SEÇENEKLERÝ] Use the Real Name of users");
...
define("_MI_PUB_WELCOME", "[ÝÇERÝK SEÇENEKLERÝ] Hoþgeldiniz baþlýðý ve mesajý görünsün mü:");
...
define("_MI_PUB_WHOWHEN", "[ÝÇERÝK SEÇENEKLERÝ] Afiþ ve tarih görünsün mü?");
define("_MI_PUB_WHOWHENDSC", "Set to 'Yes' to display the poster and date information in the individual article");
define("_MI_PUB_WYSIWYG", "[BÝÇÝM SEÇENEKLERÝ] Editor tipi");
