...
if (!function_exists('smart_TableExists')) {
 ...
 */
global $xoopsConfig;
$common_file = XOOPS_ROOT_PATH . "/modules/publisher/language/" . $xoopsConfig['language'] . "/smartdbupdater.php";
if (!file_exists($common_file)) {

	$common_file = XOOPS_ROOT_PATH . "/modules/publisher/language/english/smartdbupdater.php";
}
