<?php
// $Id: japanese.php,v 1.1 2005/08/26 20:38:06 malanciault Exp $
//  ------------------------------------------------------------------------ //
...
// ------------------------------------------------------------------------- //
require PUB_FPDF_PATH.'/japanese.php';
...
define('PUB_PDF_FORUM', 'Forum');
define('PUB_PDF_TOPIC', 'Topic');
define('PUB_PDF_SUBJECT', 'Subject');
define('PUB_PDF_AUTHOR', _POSTEDBY);
define('PUB_PDF_DATE', _MD_POSTEDON);
define('PUB_PDF_PAGE', 'Page %s');
