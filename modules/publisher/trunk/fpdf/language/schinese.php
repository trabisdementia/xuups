<?php
// $Id: schinese.php,v 1.1 2005/08/26 20:38:06 malanciault Exp $
//  ------------------------------------------------------------------------ //
...
define('PUB_PDF_FORUM', '论坛');
define('PUB_PDF_TOPIC', '主题');
define('PUB_PDF_SUBJECT', '标题');
define('PUB_PDF_AUTHOR', _POSTEDBY);
define('PUB_PDF_DATE', _MD_POSTEDON);
define('PUB_PDF_PAGE', '第%s页');
