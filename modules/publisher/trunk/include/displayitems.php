...
* Licence: GNU
*/
global $xoopsUser, $xoopsUser, $xoopsConfig, $xoopsDB, $xoopsModuleConfig, $xoopsModule, $publisher_item_handler;
$startitem = isset($_GET['startitem']) ? intval($_GET['startitem']) : 0;

$items_title = _AM_PUB_CAT_ITEMS;
$items_info = _AM_PUB_CAT_ITEMS_DSC;
$sel_cat = $categoryid;

publisher_collapsableBar('bottomtable', 'bottomtableicon', $items_title, $items_info);

// Get the total number of published ITEMS
$totalitems = $publisher_item_handler->getItemsCount($sel_cat, array(_PUB_STATUS_PUBLISHED));

// creating the items objects that are published
$itemsObj = $publisher_item_handler->getAllPublished($xoopsModuleConfig['perpage'], $startitem,$sel_cat);

$totalitemsOnPage = count($itemsObj);

$allcats = $publisher_category_handler->getObjects(null, true);
echo "<table width='100%' cellspacing=1 cellpadding=3 border=0 class = outer>";
echo "<tr>";
echo "<td width='40' class='bg3' align='center'><b>" . _AM_PUB_ITEMID . "</b></td>";
echo "<td width='20%' class='bg3' align='left'><b>" . _AM_PUB_ITEMCOLNAME . "</b></td>";
echo "<td class='bg3' align='left'><b>" . _AM_PUB_ITEMDESC . "</b></td>";
...
echo "<input type='button' name='button' onclick=\"location='item.php?op=mod&categoryid=" . $sel_cat . "'\" value='" . _AM_PUB_CREATEITEM . "'>&nbsp;&nbsp;";
echo "</div>";
