...
function list_blocks()
{
	...
	// displaying TH
    publisher_collapsableBar('blockstable', 'blocksicon', _AM_PUB_BLOCKS, _AM_PUB_BLOCKSTXT);
	...
	publisher_close_collapsable('blockstable', 'blocksicon');
}
...
function list_groups()
{
    ...
    publisher_collapsableBar('groupstable', 'groupsicon', _AM_PUB_GROUPS, _AM_PUB_GROUPSINFO);
	$item_list = array() ;
	foreach( array_keys( $block_arr ) as $i ) {
	...
	echo $form->render() ;
    publisher_close_collapsable('groupstable', 'groupsicon');
}
...
publisher_adminMenu(4, _AM_PUB_BLOCKSANDGROUPS);
