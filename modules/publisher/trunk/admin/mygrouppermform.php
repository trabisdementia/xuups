...
//		$this->XoopsForm($title, 'groupperm_form', XOOPS_URL.'/modules/system/admin/groupperm.php', 'post'); GIJ
	...
	function render()
	{
		...
		// Hack by marcan : we don't need this title here, as it is managed by publisher_collapsable
		//$ret = '<h4>'.$this->getTitle().'</h4>'.$this->_permDesc.'<br />';
		$ret = '';
		// End of Hack by marcan : we don't need this title here, as it is managed by publisher_collapsable
