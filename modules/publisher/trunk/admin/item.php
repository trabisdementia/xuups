...
switch ($op) {
    ...
    $itemObj->setVar('dobr', (isset($_POST['dolinebreak'])) ? intval($_POST['dolinebreak']) : 0);
    $itemObj->setVar('cancomment', (isset($_POST['allowcomments'])) ? intval($_POST['allowcomments']) : 0);
