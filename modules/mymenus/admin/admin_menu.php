...
{
	global $mymenusTpl, $xoopsUser, $xoopsConfig, $menu_id;
	...
	return $mymenusTpl->fetch(XOOPS_ROOT_PATH . '/modules/mymenus/templates/static/mymenus_admin_menu.html');
}
...
{
	global $xoopsUser, $xoopsConfig, $xoopsDB, $menu_id;
	include_once XOOPS_ROOT_PATH . '/class/xoopsformloader.php';
