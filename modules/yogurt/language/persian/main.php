...
######################################### SCRAPS #####################################################
//scrapbook.php
define('_MD_YOGURT_ENTERTEXTSCRAP',"Enter Text or Xoops Codes");
define("_MD_YOGURT_SENDSCRAP","post Scrap");
define("_MD_YOGURT_ANSWERSCRAP","Reply");//also present in configs.php
define("_MD_YOGURT_MYSCRAPBOOK","My Scrapbook");
define("_MD_YOGURT_CANCEL","Cancel");//also present in configs.php
define("_MD_YOGURT_SCRAPTIPS","Scrap tips");
define("_MD_YOGURT_BOLD","bold");
define("_MD_YOGURT_ITALIC","italic");
define("_MD_YOGURT_UNDERLINE","underline");
define("_MD_YOGURT_NOSCRAPSYET","No Scraps created in this Scrapbook yet");

//submit_scrap.php
define("_MD_YOGURT_SCRAP_SENT","Thanks for participating, Scrap sent");

//delete_scrap.php
define("_MD_YOGURT_ASKCONFIRMSCRAPDELETION","Are you sure you want to delete this Scrap?");
define("_MD_YOGURT_CONFIRMSCRAPDELETION","Yes please delete this Scrap.");
define("_MD_YOGURT_SCRAPDELETED","The Scrap was deleted");
...
define("_MD_YOGURT_CONFIGSSCRAPS","See your Scraps"); 
define("_MD_YOGURT_CONFIGSSCRAPSSEND","Send you Scraps");
...
define("_MD_YOGURT_TRIBESNOTENABLED", "The administrator of the site has disabled this feature");
define("_MD_YOGURT_PICTURESNOTENABLED", "The administrator of the site has disabled this feature");
define("_MD_YOGURT_SCRAPSNOTENABLED", "The administrator of the site has disabled this feature");
