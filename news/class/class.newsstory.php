...
$pathImageIcon = XOOPS_URL .'/'. $moduleInfo->getInfo('icons16');
		...
		$ret = "&nbsp; <a href=".XOOPS_URL."/modules/news/submit.php?op=edit&amp;storyid=".$this->storyid()."><img src=" . $pathImageIcon .'/edit.png'. ' '.'title='._NW_EDIT."></a>"
        ."<a href=".XOOPS_URL."/modules/news/admin/index.php?op=delete&amp;storyid=".$this->storyid()."><img src=" . $pathImageIcon."/delete.png". ' '."title="._NW_DELETE."></a> &nbsp;"        
        ;              
		return $ret;
	}
...
$pathImageIcon = XOOPS_URL .'/'. $moduleInfo->getInfo('icons16');	
		...
		if($filescount>0) {
			...
			$story['attached_link']="<a href='".XOOPS_URL.'/modules/news/article.php?storyid='.$this->storyid()."' title='"._NW_ATTACHEDLIB."'><img src=" . $pathImageIcon."/attach.png".' '. "title="._NW_ATTACHEDLIB."></a>";						
		} else {
