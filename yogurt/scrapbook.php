<?php
// $Id: scrapbook.php,v 1.12 2008/04/19 16:39:08 marcellobrandao Exp $
//  ------------------------------------------------------------------------ //
...
$xoopsOption['template_main'] = 'yogurt_scrapbook.html';
include_once '../../header.php';
include_once 'class/yogurt_controler.php';

$controler = new YogurtControlerScraps($xoopsDB,$xoopsUser);
...
if(!($scraps = $controler->fecthScraps($nbSections['nbScraps'], $criteria_uid))) {$xoopsTpl->assign('lang_noscrapsyet',_MD_YOGURT_NOSCRAPSYET);}
 
//form
$xoopsTpl->assign('lang_entertext',_MD_YOGURT_ENTERTEXTSCRAP);
$xoopsTpl->assign('lang_submit',_MD_YOGURT_SENDSCRAP);
...
$xoopsTpl->assign('lang_tips',_MD_YOGURT_SCRAPTIPS);
...
$xoopsTpl->assign('lang_mysection',_MD_YOGURT_MYSCRAPBOOK);
$xoopsTpl->assign('section_name',_MD_YOGURT_SCRAPBOOK);
