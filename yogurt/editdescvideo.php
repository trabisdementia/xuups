...
if($marker==1)
{
	...
	*/
	...
	{
		if($video_factory->insert($video)) {redirect_header('seutubo.php?uid='.$uid, 2, _MD_YOGURT_DESC_EDITED);}
		else {redirect_header('index.php?uid='.$uid, 2, _MD_YOGURT_NOCACHACA);}
	}
}
/**
