    ...
    if ( is_array($lang_list)&&count( $lang_list ) > 0 ){
        ...
        foreach( array_keys($lang_list) as $lang_name ) {
	        ...
	        if(isset($lang['base'])){
	            ...
	            echo "<td class='$class' ><a href='main.php?op=edit&amp;type=base&amp;lang_id=" . $lang['base'] -> getVar('lang_id') . "'><img src=".$pathImageIcon.'/edit.png title=' . _EDIT . "></a>\n".
	             "<a href='main.php?op=del&amp;type=base&amp;lang_id=" . $lang['base'] -> getVar('lang_id') . "'><img src=".$pathImageIcon.'/delete.png title=' . _DELETE ."></td>\n";
	            echo "</tr>\n";
	        	$isOrphan = false;
            ...
            foreach($lang['ext'] as $ext){
	            ...
	            echo "<td class='$class' ><a href='main.php?op=edit&amp;type=ext&amp;lang_id=" . $ext -> getVar('lang_id') . "'><img src=".$pathImageIcon.'/edit.png title=' . _EDIT . "></a>\n".
	            "<a href='main.php?op=del&amp;type=ext&amp;lang_id=" . $ext -> getVar('lang_id') . "'><img src=".$pathImageIcon.'/delete.png title=' . _DELETE ."></td>\n";
	            echo "</tr>\n";
            }
