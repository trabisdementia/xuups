...
define("_MI_POLLS_NAME","XOOPS Polls");
...
// index.php
define("_AM_POLLS_HOME",                  "Home");
define("_AM_POLLS_ADMENU1",                  "List Polls");
define("_AM_POLLS_ADMENU2",                 "Add Poll");
define("_AM_POLLS_ADMIN_ABOUT",                  "About");
define("_AM_XOOPSPOLLS_ADMIN_HELP",                 "Help");
