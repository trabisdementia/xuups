...
define("_MI_YOG_PICTURE_TEMPLATESCRAPBOOKDESC","Template para o Scrapbook"); //GibaPhp
...
define("_MI_YOGURT_MYSCRAPS","Meus Scraps"); //GibaPhp
...
define("_MI_YOG_SCRAP_NOTIFYDSC","Notificações de Scrapbook"); //GibaPhp
define("_MI_YOG_SCRAP_NEWSCRAP_NOTIFY","Novo scrap"); //GibaPhp
define("_MI_YOG_SCRAP_NEWSCRAP_NOTIFYCAP","Avise-me quando um novo Scrap for enviado para este Scrapbook"); //GibaPhp
define("_MI_YOG_SCRAP_NEWSCRAP_NOTIFYDSC","Aviso - Descrição do Novo scrap"); //GibaPhp - dúvida aqui...
define("_MI_YOG_SCRAP_NEWSCRAP_NOTIFYSBJ","{X_OWNER_NAME} Apresentou um novo Scrap dentro do seu Scrapbook"); //GibaPhp
...
define("_MI_YOG_ENABLESCRAPS_TITLE","Ativar a seção de Scraps"); //GibaPhp
define("_MI_YOG_ENABLESCRAPS_DESC","Ativando a seção de Scraps, permitirá que os membros possam deixar mensagens públicas no Scrap de outros usuários. Esse recurso é como você conhece no Facebook"); //GibaPhp
...
define("_MI_YOG_SCRAPSPERPAGE_TITLE","Número de Scraps por página"); //GibaPhp
define("_MI_YOG_SCRAPSPERPAGE_DESC","Número de Scraps em uma página antes de mostrar a navegação e paginação "); //GibaPhp
