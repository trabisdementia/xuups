...
class PublisherItemForm extends PublisherThemeTabForm {
    ...
    function isGranted($item) {
        ...
        $ret = false;
        if (!$this->checkperm || $publisher->getHelper('permission')->isGranted('form_view', $item)) {
            $ret = true;
        }
        return $ret;
    }
    ...
    function createElements($obj) {
        ...
        $allowed_editors = publisher_getEditors($publisher->getHelper('permission')->getGrantedItems('editors'));
        $form_view = $publisher->getHelper('permission')->getGrantedItems('form_view');
