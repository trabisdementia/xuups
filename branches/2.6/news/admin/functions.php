	...
	<div class="outerbar">
		<div class="dojo-FisheyeList"
			...
			<div class="dojo-FisheyeListItem" onClick="load_app(1);"
				dojo:iconsrc="../images/dojo/home.png" caption="<?php echo _AM_NEWS_GOTOMOD; ?>">
			</div>
			<div class="dojo-FisheyeListItem" onClick="load_app(2);"
				dojo:iconsrc="../images/dojo/help.png" caption="<?php echo _AM_NEWS_HELP; ?>">
			</div>
			<div class="dojo-FisheyeListItem" onClick="load_app(3);"
				dojo:iconsrc="../images/dojo/maintain.png" caption="<?php echo _AM_NEWS_VERIFY_TABLES; ?>">
			</div>
			<div class="dojo-FisheyeListItem" onClick="load_app(4);"
				dojo:iconsrc="../images/dojo/topics.png" caption="<?php echo _MI_NEWS_ADMENU2; ?>">
			</div>
			<div class="dojo-FisheyeListItem" onClick="load_app(5);"
				dojo:iconsrc="../images/dojo/articles.png" dojo:caption="<?php echo _MI_NEWS_ADMENU3; ?>" >
			</div>
			<div class="dojo-FisheyeListItem" onClick="load_app(6);"
				dojo:iconsrc="../images/dojo/permissions.png" dojo:caption="<?php echo _MI_NEWS_GROUPPERMS; ?>" >
			</div>
			<div class="dojo-FisheyeListItem" onClick="load_app(7);"
				dojo:iconsrc="../images/dojo/purge.png" dojo:caption="<?php echo _MI_NEWS_PRUNENEWS; ?>" >
			</div>
			<div class="dojo-FisheyeListItem" onClick="load_app(8);"
				dojo:iconsrc="../images/dojo/export.png" dojo:caption="<?php echo _MI_NEWS_EXPORT; ?>" >
			</div>
			<div class="dojo-FisheyeListItem" onClick="load_app(9);"
				dojo:iconsrc="../images/dojo/newsletter.png" dojo:caption="<?php echo _MI_NEWS_NEWSLETTER; ?>" >
			</div>
			<div class="dojo-FisheyeListItem" onClick="load_app(10);"
				dojo:iconsrc="../images/dojo/statistics.png" dojo:caption="<?php echo _MI_NEWS_STATS; ?>" >
			</div>
			<div class="dojo-FisheyeListItem" onClick="load_app(11);"
				dojo:iconsrc="../images/dojo/metagen.png" dojo:caption="<?php echo _MI_NEWS_METAGEN; ?>" >
			</div>
			<?php if ($xoopsModule->getVar('version') != 153) { ?>
				<div class="dojo-FisheyeListItem" onClick="load_app(12);"
					dojo:iconsrc="../images/dojo/update.png" dojo:caption="<?php echo _AM_NEWS_UPGRADE; ?>" >
				</div>
			<?php } ?>
		</div>
	</div>
