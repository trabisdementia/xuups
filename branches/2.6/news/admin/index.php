...
{
    global $dateformat, $pathImageIcon;
    ...
    if ( count($storyarray)> 0) {
		...
		echo "<img onclick=\"toggle('toptable'); toggleIcon('toptableicon');\" id='topnewsubicon' name='topnewsubicon' src='" . $pathImageIcon."/close12.gif' alt='' /></a>&nbsp;"._AM_NEWSUB."</h4>";
		echo "<div id='newsub'>";
		echo '<br />';
...
function autoStories()
{
    ...
    if(count($storyarray) > 0) {
		...
		echo "<img onclick=\"toggle('toptable'); toggleIcon('toptableicon');\" id='topautostories' name='topautostories' src='" . $pathImageIcon."/close12.gif' alt='' /></a>&nbsp;"._AM_AUTOARTICLES."</h4>";
...
function lastStories()
{
	...
	echo "<img onclick=\"toggle('toptable'); toggleIcon('toptableicon');\" id='toplaststories' name='toplaststories' src='" . $pathImageIcon."/close12.gif' alt='' /></a>&nbsp;".sprintf(_AM_LAST10ARTS,news_getmoduleoption('storycountadmin'))."</h4>";
    ...
    foreach( $storyarray as $eachstory ) {
        ...
        echo "<td align='center'><b>" . $eachstory -> storyid() . "</b>
			...
			<a href='".XOOPS_URL."/modules/news/admin/index.php?op=delete&amp;storyid=" . $eachstory -> storyid() . "'><img src='" . $pathImageIcon."/delete.png' title='"._AM_DELETE."'></a>";
...
function expStories()
{
    ...
    if(count($storyarray) > 0) {
		...
		echo "<img onclick=\"toggle('toptable'); toggleIcon('toptableicon');\" id='topexpstories' name='topexpstories' src='" . $pathImageIcon."/close12.gif' alt='' /></a>&nbsp;"._AM_EXPARTS."</h4>";
...
function topicsmanager()
{
    ...
    echo "<img onclick=\"toggle('toptable'); toggleIcon('toptableicon');\" id='toptopicsmanager' name='toptopicsmanager' src='" . $pathImageIcon."/close12.gif' alt='' /></a>&nbsp;"._AM_TOPICSMNGR . ' (' . $totaltopics . ')'."</h4>";    
	...
	if(is_array($topics_arr) && $totaltopics) {
		...
		while($ok) {
			if($tmpcpt < $totaltopics) {
               ...
               $action_edit="<a href=index.php?op=topicsmanager&amp;topic_id=" . $topics_arr[$tmpcpt]['topic_id'] .'><img src='. $pathImageIcon.'/edit.png title='._AM_EDIT."></a>";   
               $action_delete="<a href=index.php?op=delTopic&amp;topic_id=" . $topics_arr[$tmpcpt]['topic_id'].'><img src='. $pathImageIcon.'/delete.png title='._AM_DELETE."'></a>";	
				...
				$output  = $output . "<tr class='".$class."'><td>" . $topics_arr[$tmpcpt]['topic_id'] . "</td><td align='left'>" . $topics_arr[$tmpcpt]['prefix'] . $myts->displayTarea($topics_arr[$tmpcpt]['topic_title']) . "</td><td align='left'>" . $parent . "</td><td>" . $submenu . "</td><td>" . $action_edit . $action_delete ."</td></tr>";
