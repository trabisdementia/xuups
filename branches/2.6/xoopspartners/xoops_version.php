...
$modversion['name'] = _MI_XPARTNERS_NAME;
$modversion['version'] = 1.11;
$modversion['author'] = 'Raul Recio';
$modversion['nickname'] = 'unfor';
$modversion['description'] = _MI_XPARTNERS_DESC;
$modversion['credits'] = "Mage, Mamba, ZySpec";
...
$modversion['release_date'] = '2011/04/16';
...
$modversion['blocks'][1]['name'] = _MI_XPARTNERS_NAME;
$modversion['blocks'][1]['description'] = _MI_XPARTNERS_DESC;
...
$i = 1;
$modversion['templates'][$i]['file'] = 'xoopspartners_index.html';
$modversion['templates'][$i]['description'] = 'Partners main Screen';
$i++;
$modversion['templates'][$i]['file'] = 'xoopspartners_join.html';
$modversion['templates'][$i]['description'] = 'Shows Join to the partners Form';
$i++;
...
$modversion['config'][1]['title'] = '_MI_XPARTNERS_RECLICK';
...
$modversion['config'][1]['options'] = array(
    '_MI_XPARTNERS_HOUR' => '3600', '_MI_XPARTNERS_3HOURS' => '10800', '_MI_XPARTNERS_5HOURS' => '18000', '_MI_XPARTNERS_10HOURS' => '36000', '_MI_XPARTNERS_DAY' => '86400'
);

$modversion['config'][2]['name'] = 'modlimit';
$modversion['config'][2]['title'] = '_MI_XPARTNERS_MLIMIT';
$modversion['config'][2]['description'] = '_MI_XPARTNERS_MLIMITDSC';
$modversion['config'][2]['formtype'] = 'textbox';
$modversion['config'][2]['valuetype'] = 'int';
$modversion['config'][2]['default'] = 5;

$modversion['config'][3]['name'] = 'modshow';
$modversion['config'][3]['title'] = '_MI_XPARTNERS_MSHOW';
$modversion['config'][3]['description'] = '_MI_XPARTNERS_MSHOWDSC';
$modversion['config'][3]['formtype'] = 'select';
$modversion['config'][3]['valuetype'] = 'int';
$modversion['config'][3]['default'] = 1;
$modversion['config'][3]['options'] = array(
    '_MI_XPARTNERS_IMAGES' => 1, '_MI_XPARTNERS_TEXT' => 2, '_MI_XPARTNERS_BOTH' => 3
);

$modversion['config'][4]['name'] = 'modorder';
$modversion['config'][4]['title'] = '_MI_XPARTNERS_MORDER';
$modversion['config'][4]['description'] = '_MI_XPARTNERS_MORDERDSC';
$modversion['config'][4]['formtype'] = 'select';
$modversion['config'][4]['valuetype'] = 'text';
$modversion['config'][4]['default'] = 'hits';
$modversion['config'][4]['options'] = array(
    '_MI_XPARTNERS_ID' => 'id', '_MI_XPARTNERS_HITS' => 'hits', '_MI_XPARTNERS_TITLE' => 'title', '_MI_XPARTNERS_WEIGHT' => 'weight'
);

$modversion['config'][5]['name'] = 'modorderd';
$modversion['config'][5]['title'] = '_MI_XPARTNERS_MORDER';
$modversion['config'][5]['description'] = '_MI_XPARTNERS_MORDERDSC';
