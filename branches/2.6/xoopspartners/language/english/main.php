...
define('_MD_XPARTNERS_ERROR2', "<span style='text-align: center'>"
    . "Image size is larger than 150x80. <a href='javascript:history.back(1)'>Try with another image</a>" . "</span>");
define('_MD_XPARTNERS_ERROR3', "<style='text-align: center;'>"
    . "The image file doesn't exist. <a href='javascript:history.back(1)'>Try with another image</a>" . "</span>");
