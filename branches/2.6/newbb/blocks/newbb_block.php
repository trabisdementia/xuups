...
function b_newbb_show($options)
{
    ...
    foreach ($rows as $arr) {
        ...
        $seo_url = '<a href="'.XOOPS_URL.'/modules/newbb/viewtopic.php?post_id='.$topic['post_id'].'">'.$topic['title'].'</a>';
    ...
    $seo_top_allforums = '<a href="'.XOOPS_URL.'/modules/newbb/">'._MB_NEWBB_VSTFRMS.'</a>';
    $block['seo_top_allforums'] =  (!empty($newbbConfig['do_rewrite'])) ? seo_urls($seo_top_allforums) : $seo_top_allforums;
    $seo_top_allforums = '<a href="'.XOOPS_URL.'/modules/newbb/list.topic.php">'._MB_NEWBB_ALLTOPICS.'</a>';
    $block['seo_top_alltopics'] =  (!empty($newbbConfig['do_rewrite'])) ? seo_urls($seo_top_allforums) : $seo_top_allforums;
    $seo_top_allforums = '<a href="'.XOOPS_URL.'/modules/newbb/viewpost.php">'._MB_NEWBB_ALLPOSTS.'</a>';
