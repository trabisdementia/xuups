...
//DFK 4.05 - rem (useful only in debug)
//echo $mode." - ".$status;
...
$all_link = "viewpost.php?forum=".$forum_id."&amp;start=$start";
$post_link = "viewpost.php?forum=".$forum_id;
$newpost_link = "viewpost.php?forum=".$forum_id."&amp;status=new";
$digest_link = "viewpost.php?forum=".$forum_id."&amp;start=$start&amp;status=digest";
$unreplied_link = "viewpost.php?forum=".$forum_id."&amp;start=$start&amp;status=unreplied";
$unread_link = "viewpost.php?forum=".$forum_id."&amp;start=$start&amp;status=unread";
