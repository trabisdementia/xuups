...
class Post extends ArtObject {
	...
	//4.05 - social links - TODO: add config to toggle on/off links
	//if($xoopsModuleConfig['show_sociallinks'])
        {
            ...
            $thread_action['social_stumbleupon']['image'] = newbb_displayImage('stumbleupon', _MD_SHARE_STUMBLEUPON);
            $thread_action['social_stumbleupon']['link'] = "http://www.stumbleupon.com/submit?url=".$full_link;
            $thread_action['social_stumbleupon']['name'] = _MD_SHARE_STUMBLEUPON;
            $thread_action['social_stumbleupon']['target'] = '_blank';  

            $thread_action['social_friendfeed']['image'] = newbb_displayImage('friendfeed', _MD_SHARE_FRIENDFEED);
            $thread_action['social_friendfeed']['link'] = "http://friendfeed.com/?title=".$full_title."&amp;url=".$full_link;
            $thread_action['social_friendfeed']['name'] = _MD_SHARE_FRIENDFEED;
            $thread_action['social_friendfeed']['target'] = '_blank';  
	    ...
	    $thread_action['social_technorati']['image'] = newbb_displayImage('technorati', _MD_SHARE_REDDIT);
            $thread_action['social_technorati']['link'] = "http://technorati.com/faves/?add=".$full_link;
            $thread_action['social_technorati']['name'] = _MD_SHARE_REDDIT;
            $thread_action['social_technorati']['target'] = '_blank';  
        ...
        $post = array(
	    		'post_id' => $post_id,
	                ...
	                'poster' => $poster,
                    'post_permalink'    => '<a href="viewtopic.php?post_id='.$post_id.'"></a>'
	    );
