...
//  fixed/updated by Defkon1 - www.xoopsitalia.org
...
define("_MI_NEWBB_INSTALL_POST_TEXT", "
	...
	If you have any question concerning CBB usage, please visit your local support site or [url=http://xoopsforge.com/modules/newbb/]CBB Module Site[/url].
	");
...
define("_MI_SUBJECT_PREFIX_DESC", "Set a prefix, such as [H] at the beginning of the subject. For more options, please separate them with a ','. NONE is no prefix.");
define("_MI_SUBJECT_PREFIX_DEFAULT", '<font color="#00CC00">[solved]</font>,<font color="#00CC00">[done]</font>,<font color="#FF0000">[request]</font>,<font color="#FF0000">[bug]</font>,<font color="#FF0000">[unsolved]</font>');

define("_MI_SUBJECT_PREFIX_LEVEL", "Permissions for use of prefixes");

define("_MI_SUBJECT_PREFIX_LEVEL_DESC", "Select group(s) enabled for prefixes use.");
