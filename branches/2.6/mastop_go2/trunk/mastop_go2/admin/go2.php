...
switch ($op) {
    ...
    case 'listar_dstac':
        ...
        $c['tipo'][6] = "simnao";
        $c['show'][6] = '($reg->getVar("go2_12_ativo") == 0) ? "<a href=\'go2.php?op=ativar&go2_10_id=".$reg->getVar($reg->id)."\'><img src='. $pathImageIcon .'/green_off.gif align=\'absmiddle\'></a> <img src='. $pathImageIcon .'/red.gif align=\'absmiddle\'>" : "<img src='. $pathImageIcon .'/green.gif align=\'absmiddle\'> <a href=\'go2.php?op=desativar&go2_10_id=".$reg->getVar($reg->id)."\'><img src='. $pathImageIcon .'/red_off.gif align=\'absmiddle\'></a>"';
