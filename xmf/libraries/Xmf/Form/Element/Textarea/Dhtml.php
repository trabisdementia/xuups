 ...
 * @subpackage  form
 */
class Xmf_Form_Element_TextArea_Dhtml extends Xmf_Form_Element_TextArea
{
    /**
    ...
    function __construct($caption, $name, $value = "", $rows = 5, $cols = 50, $hiddentext = "xoopsHiddenText", $options = array() )
    {
        ...
        if (!isset($options['editor'])) {
            ...
            if (!empty($configs['editor'])) $options['editor'] = $configs['editor'];
        }
    ...
    function fontArray()
    {
        ...
        $fontStr .=
            "+ '<select id=\'{$textarea_id}Font\' onchange=\'xoopsSetElementAttribute(\"font\", this.options[this.selectedIndex].value, \"{$textarea_id}\", \"{$hiddentext}\");\'>'" .
        ...
        $fontStr .=
            "+ '<select id=\'{$textarea_id}Color\' onchange=\'xoopsSetElementAttribute(\"color\", this.options[this.selectedIndex].value, \"{$textarea_id}\", \"{$hiddentext}\");\'>'" .
