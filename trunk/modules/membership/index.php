...
if (!in_array($letter, $perm_letter)) $letter = _MA_MSHIP_ALL;
...
printf(_MA_MSHIP_WELCOMETO,$xoopsConfig['sitename']);
echo "</b><br /><br />\n";
echo _MA_MSHIP_GREETINGS." <a href='".XOOPS_URL."/userinfo.php?uid=".$lastuid."'>".$lastuser."</a></div>\n";
...
echo "<input type='submit' value='"._MA_MSHIP_SEARCH."' /></form></td><td>";

echo "<form action='".XOOPS_URL."/modules/membership/index.php' method='post'>";
echo "<input type='submit' value='" ._MA_MSHIP_RESETSEARCH."' />";
...
if ( $letter != "front" ) {
	...
	echo "<td align='center'><span ><b><a href='".XOOPS_URL."/modules/membership/index.php?letter=".$letter."&sortby=user_avatar&orderby=".$orderby."&query=".$query."'>"._MA_MSHIP_AVATAR."</a></b></span></td>\n";
    echo "<td align='center'><span ><b><a href='".XOOPS_URL."/modules/membership/index.php?letter=".$letter."&sortby=uname&orderby=".$orderby."&query=".$query."'>"._MA_MSHIP_NICKNAME."</a></b></span></td>\n";

	echo "<td align='center'><span ><b><a href='".XOOPS_URL."/modules/membership/index.php?letter=".$letter."&sortby=user_regdate&orderby=".$orderby."&query=".$query."'>"._MA_MSHIP_REGDATE."</a></b></span></td>\n";
    echo "<td align='center'><span ><b><a href='".XOOPS_URL."/modules/membership/index.php?letter=".$letter."&sortby=email&orderby=".$orderby."&query=".$query."'>"._MA_MSHIP_EMAIL."</a></b></span></td>\n";
	echo "<td align='center'><span ><b><a href='".XOOPS_URL."/modules/membership/index.php?letter=".$letter."&sortby=email&orderby=".$orderby."&query=".$query."'>"._MA_MSHIP_PM."</a></b></span></td>\n";
    echo "<td align='center'><span ><b><a href='".XOOPS_URL."/modules/membership/index.php?letter=".$letter."&sortby=url&orderby=".$orderby."&query=".$query."'>"._MA_MSHIP_URL."</a></b></span></td>\n";
    $cols = 7;
    if ( $xoopsUser ) {
		if ( $xoopsUser->isAdmin() ) {
            $cols = 8;
           	echo "<td align='center'><span ><b><a href='".XOOPS_URL."/modules/membership/index.php?letter=".$letter."&sortby=email&orderby=".$orderby."&query=".$query."'>"._MA_MSHIP_FUNCTIONS."</a></b></span></td>\n";
		}
    }
    echo "</tr>";
    $a = 0;
    ...
    if ( $num_rows_per_order > 0  ) {
        while ( $userinfo = $xoopsDB->fetchArray($result) ) {
            ...
            if ( $xoopsUser ) {
				if ( $xoopsUser->isAdmin() ) {
                    echo "<td align='center'>[ <a href='".XOOPS_URL."/modules/system/admin.php?fct=users&op=reactivate&uid=".$userinfo->uid()."&op=modifyUser'>"._MA_MSHIP_EDIT."</a> | \n";
                    echo "<a href='".XOOPS_URL."/modules/system/admin.php?fct=users&op=delUser&uid=".$userinfo->uid()."'>"._MA_MSHIP_DELETE."</a> ]</td>\n";
				}
            }
           	echo "</tr>";
        ...
        echo "<b>";
        printf(_MA_MSHIP_NOUSERFOUND,$letter);
        echo "</b>\n";
        echo "<br /></td></tr>\n";
