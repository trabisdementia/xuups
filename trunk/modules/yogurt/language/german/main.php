...
define("_MD_YOGURT_SCRAPBOOK","G&auml;stebuch");
...
######################################### SCRAPS #####################################################
//scrapbook.php
define('_MD_YOGURT_ENTERTEXTSCRAP',"Text eingeben");
define("_MD_YOGURT_SENDSCRAP","Eintrag schreiben");
define("_MD_YOGURT_ANSWERSCRAP","Antworten");//also present in configs.php
define("_MD_YOGURT_MYSCRAPBOOK","Mein G&auml;stebuch");
define("_MD_YOGURT_CANCEL","Abbrechen");//also present in configs.php
define("_MD_YOGURT_SCRAPTIPS","G&auml;stebuch-Tipps");
define("_MD_YOGURT_BOLD","Fett");
define("_MD_YOGURT_ITALIC","Kursiv");
define("_MD_YOGURT_UNDERLINE","Unterstrichen");
define("_MD_YOGURT_NOSCRAPSYET","Keine G&auml;stebucheintr&auml;ge vorhanden, hier kannst Du noch erster sein!");

//submit_scrap.php
define("_MD_YOGURT_SCRAP_SENT","Danke f&uuml;r die Teilnahme, G&auml;stebucheintrag wurde gesendet");

//delete_scrap.php
define("_MD_YOGURT_ASKCONFIRMSCRAPDELETION","Willst du diesen Eintrag wirklich l&ouml;schen?");
define("_MD_YOGURT_CONFIRMSCRAPDELETION","Ja, diesen Eintrag l&ouml;schen.");
define("_MD_YOGURT_SCRAPDELETED","G&auml;stebucheintrag wurde gel&ouml;scht");
...
define("_MD_YOGURT_CONFIGSSCRAPS","Deine G&auml;stebucheintr&auml;ge sehen"); 
define("_MD_YOGURT_CONFIGSSCRAPSSEND","Darf dir ins G&auml;stebuch schreiben");
...
define("_MD_YOGURT_SCRAPSNOTENABLED", "Die G&auml;stebuch-Funktion ist im Moment deaktiviert");
