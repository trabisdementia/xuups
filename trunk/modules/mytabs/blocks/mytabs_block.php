...
function b_mytabs_block_show($options) {
    ...
    foreach ($vistabs as $tab){
        ...
        $tab_blocks = mytabsblock_show($pageid, $tab->getVar('tabid'),'',$options[6]);
    ...
    if (is_object($xoTheme)){
        ...
        $xoopsTpl->assign( 'xoops_module_header' , '<link rel="stylesheet" type="text/css" media="all" href="'.XOOPS_URL.'/modules/mytabs/menus/'.$options[3].'/style.css" /><script type="text/javascript" src="'.XOOPS_URL.'/modules/mytabs/jscript/tabcontent.js"></script>'.$xoopsTpl->get_template_vars("xoops_module_header") );
    }
