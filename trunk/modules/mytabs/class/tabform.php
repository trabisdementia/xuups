...
class MytabsTabForm extends XoopsThemeForm {
    function createElements($target) {
       ...
       /* $this->addElement(new XoopsFormDateTime(_AM_MYTABS_PUBLISHDATE, 'fromdate', 15, $target->getVar('fromdate', 'e')));
        ...
        $this->addElement(new XoopsFormText(_AM_MYTABS_PRIORITY.":","taborder",4,5,$target->getVar('taborder', 'e')));
        ...
        $cancel->setExtra("onclick=\"self.location='page.php?pageid=".$target->getVar('tabpageid')."';\"");
