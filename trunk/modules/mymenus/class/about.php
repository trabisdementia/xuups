...
//  Credits: The SmartFactory <www.smartfactory.ca>
...
class MymenusAbout
{
	...
	function MymenusAbout($aboutTitle = 'About')
	{
		...
		$this->_lang_developer_contributor = _AB_MYMENUS_DEVELOPER_CONTRIBUTOR;
		$this->_lang_developer_website = _AB_MYMENUS_DEVELOPER_WEBSITE;
		$this->_lang_developer_email = _AB_MYMENUS_DEVELOPER_EMAIL;
		$this->_lang_developer_credits = _AB_MYMENUS_DEVELOPER_CREDITS;
		$this->_lang_module_info = _AB_MYMENUS_MODULE_INFO;
		$this->_lang_module_status = _AB_MYMENUS_MODULE_STATUS;
		$this->_lang_module_release_date =_AB_MYMENUS_MODULE_RELEASE_DATE ;
		$this->_lang_module_demo = _AB_MYMENUS_MODULE_DEMO;
		$this->_lang_module_support = _AB_MYMENUS_MODULE_SUPPORT;
		$this->_lang_module_bug = _AB_MYMENUS_MODULE_BUG;
		$this->_lang_module_submit_bug = _AB_MYMENUS_MODULE_SUBMIT_BUG;
		$this->_lang_module_feature = _AB_MYMENUS_MODULE_FEATURE;
		$this->_lang_module_submit_feature = _AB_MYMENUS_MODULE_SUBMIT_FEATURE;
		$this->_lang_module_disclaimer = _AB_MYMENUS_MODULE_DISCLAIMER;
		$this->_lang_author_word = _AB_MYMENUS_AUTHOR_WORD;
		$this->_lang_version_history = _AB_MYMENUS_VERSION_HISTORY;
	...
	function render()
	{
		...
		$this->_tpl->display(XOOPS_ROOT_PATH . '/modules/' . $xoopsModule->getVar('dirname') . '/templates/static/mymenus_admin_about.html');
