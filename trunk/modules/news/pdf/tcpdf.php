...
// Johannes G� for JavaScript support.
...
// Esteban JoꪠMar쬠for OpenType font conversion.
...
if (!class_exists('TCPDF', false)) {
	 ...
	 */
	define('PDF_PRODUCER','TCPDF 4.1.000 (http://www.tcpdf.org)');
	...
	*/
	class TCPDF {
	 ...
	 /**
		...
		* Adds a javascript
		* @access public
		* @author Johannes G�, Nicola Asuni
		* @since 2.1.002 (2008-02-12)
		*/
			...
			switch($tag['value']) {
				...
				case 'img': {
					if (isset($tag['attribute']['src'])) {
						...
						$tag['attribute']['src'] = str_replace(K_PATH_URL, XOOPS_ROOT_PATH.'/', $tag['attribute']['src']);
