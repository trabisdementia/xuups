...
class Xmf_Form
{
    ...
    function __construct($title, $name, $action, $method = "post", $addtoken = false)
    {
        ...
        $this->_method = $method;
        if ($addtoken != false) {
            $this->addElement(new Xmf_Form_Element_Hiddentoken());
        }
    }
     ...
     */
    function addElement(Xmf_Form_Element &$formElement, $required = false)
    {
        if (is_string($formElement)) {
            $this->_elements[] = $formElement;
        } elseif (is_subclass_of($formElement, 'Xmf_Form_Element')) {
            $this->_elements[] =& $formElement;
