...
if (!($publisher_isAdmin ||
	($publisher->getConfig('perm_submit') && $publisher->getConfig('perm_submit') == 1 && (is_object($xoopsUser) || ($publisher->getConfig('perm_anon_submit') && $publisher->getConfig('perm_anon_submit') == 1))))
	) {
...
switch ($op) {
	...
	default:
        ...
        include_once PUBLISHER_ROOT_PATH . '/include/fileform.inc.php';
