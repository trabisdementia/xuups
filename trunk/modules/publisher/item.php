...
if ($publisher->getConfig('perm_rating')) {
    ...
    if (is_object($xoTheme)){
        ...
        $xoopsTpl->assign( 'xoops_module_header' , '<script type="text/javascript" src="' . PUBLISHER_URL . '/js/behavior.js"></script>
                                                    <script type="text/javascript" src="' . PUBLISHER_URL . '/js/rating.js"></script>'
