 ...
 * @version         $Id: upgrade.php 0 2009-06-11 18:47:04Z trabis $
 */
...
function checkTables()
{
    global $oAdminButton;
    xoops_cp_header();
    publisher_adminmenu(-1, _AM_PUBLISHER_DB_CHECKTABLES);
    ...
    $currentVer = round($publisher->getModule()->getVar('version') / 100, 2);
    printf('<h2>'._AM_PUBLISHER_DB_CURRENTVER.'</h2>', $currentVer);
    printf('<h2>'._AM_PUBLISHER_DB_DBVER.'</h2>', $ver);


    if ($ver == $currentVer) {
        //No updates are necessary
        echo '<div>'._AM_PUBLISHER_DB_NOUPDATE.'</div>';

    } elseif ( $ver < $currentVer) {
        //Needs to upgrade
        echo '<div>'._AM_PUBLISHER_DB_NEEDUPDATE.'</div>';
        echo '<div style="line-height: 20px; font-size: 16px; padding-bottom: 10px; padding-top:10px; color: red; font-weight: bold;">' . _AM_PUBLISHER_DB_NEEDUPDATE_WARNING . '</div>';
        echo "<form method=\"post\" action=\"upgrade.php\"><input type=\"hidden\" name=\"op\" value=\"upgradeDB\" /><input type=\"submit\" value=\"". _AM_PUBLISHER_DB_UPDATE_NOW . "\" /></form>";
    } else {
        //Tried to downgrade
        echo '<div>'._AM_PUBLISHER_DB_NEEDINSTALL.'</div>';
    }
...
function upgradeDB()
{
    ...
    if (!publisher_tableExists('publisher_meta')) {
        ...
        if (!$ver = publisher_getMeta('version')) {
            exit(_AM_PUBLISHER_DB_VERSION_ERR);
        }
    }

    xoops_cp_header();
    publisher_adminMenu(-1, _AM_PUBLISHER_DB_UPDATE_DB);
    echo "<h2>"._AM_PUBLISHER_DB_UPDATE_DB."</h2>";
    $ret = true;
...
/// PUBLISHER 0.93 ////////////////////////////////////////////////
    case '0.93':
        set_time_limit(60);
        printf("<h3>". _AM_PUBLISHER_DB_UPDATE_TO."</h3>", '1.0' );
        echo "<ul>";
...
/// PUBLISHER 1.0 ////////////////////////////////////////////////
    case '1.0':
    	set_time_limit(60);
        printf("<h3>". _AM_PUBLISHER_DB_UPDATE_TO."</h3>", '1.01' );
        echo "<ul>";
...
/// PUBLISHER 1.0.1 ////////////////////////////////////////////////
    case '1.01':
    	set_time_limit(60);
        printf("<h3>". _AM_PUBLISHER_DB_UPDATE_TO."</h3>", '1.02' );
        echo "<ul>";
...
/// PUBLISHER 1.0.2 ////////////////////////////////////////////////
    case '1.02':
    	set_time_limit(60);
        printf("<h3>". _AM_PUBLISHER_DB_UPDATE_TO."</h3>", '1.03' );
        echo "<ul>";
...
/// PUBLISHER 1.0.3 ////////////////////////////////////////////////
       case '1.03':
    	set_time_limit(60);
        printf("<h3>". _AM_PUBLISHER_DB_UPDATE_TO."</h3>", '1.04' );
        echo "<ul>";
...
/// PUBLISHER 1.0.4 ////////////////////////////////////////////////
       case '1.04':
    	set_time_limit(60);
        printf("<h3>". _AM_PUBLISHER_DB_UPDATE_TO."</h3>", '1.05' );
        echo "<ul>";
...
/// PUBLISHER 1.0.5 ////////////////////////////////////////////////
       case '1.05':
    	set_time_limit(60);
        printf("<h3>". _AM_PUBLISHER_DB_UPDATE_TO."</h3>", '1.1' );
        echo "<ul>";
...
/// PUBLISHER 1.1 ////////////////////////////////////////////////
       case '1.1':
    	set_time_limit(60);
        printf("<h3>". _AM_PUBLISHER_DB_UPDATE_TO."</h3>", '2.0' );
        echo "<ul>";
...
/// PUBLISHER 2.0 ////////////////////////////////////////////////
       case '2.0':
    	set_time_limit(60);
        printf("<h3>". _AM_PUBLISHER_DB_UPDATE_TO."</h3>", '2.1' );
        echo "<ul>";
        ...
        $itemsObj = $publisher->getHandler('item')->getObjects();
		...
		case '2.1':
    	set_time_limit(60);
        printf("<h3>". _AM_PUBLISHER_DB_UPDATE_TO."</h3>", '2.11' );
        echo "<ul>";
    ...
    $newversion = round($publisher->getModule()->getVar('version') / 100, 2);
    //if successful, update publisher_meta table with new ver
    if ($ret) {
        printf(_AM_PUBLISHER_DB_UPDATE_OK, $newversion);
        $ret = publisher_setMeta('version', $newversion);
    } else {
        printf(_AM_PUBLISHER_DB_UPDATE_ERR, $newversion);
    }
