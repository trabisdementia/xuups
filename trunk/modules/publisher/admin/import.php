 ...
 * @version         $Id: import.php 0 2009-06-11 18:47:04Z trabis $
 */
...
switch ($op) {
	...
	if (!file_exists($importfile_path)) {
		$errs[] = sprintf(_AM_PUBLISHER_IMPORT_FILE_NOT_FOUND, $importfile_path);
		$error = true;
	} else {
	...
	echo "<br />";
	if ($error == true) {
		$endMsg = _AM_PUBLISHER_IMPORT_ERROR;
	} else {
		$endMsg = _AM_PUBLISHER_IMPORT_SUCCESS;
	}

	echo $endMsg;
	echo "<br /><br />";
	echo "<a href='" . XOOPS_URL . "/modules/" . $publisher->getModule()->dirname() . "/admin/import.php'>" . _AM_PUBLISHER_IMPORT_BACK . "</a>";
	echo "<br /><br />";
	break;
