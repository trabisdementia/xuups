...
$adminmenu[0]['title'] 	= _MI_MYSEARCH_ADMMENU1;
$adminmenu[0]['link'] 	= "admin/index.php?op=stats";
$adminmenu[1]['title'] 	= _MI_MYSEARCH_ADMMENU2;
$adminmenu[1]['link'] 	= "admin/index.php?op=purge";
$adminmenu[2]['title'] 	= _MI_MYSEARCH_ADMMENU3;
$adminmenu[2]['link'] 	= "admin/index.php?op=export";
$adminmenu[3]['title'] 	= _MI_MYSEARCH_ADMMENU4;
$adminmenu[3]['link'] 	= "admin/index.php?op=blacklist";
$adminmenu[4]['title'] 	= _MI_MYSEARCH_ADMMENU5;
