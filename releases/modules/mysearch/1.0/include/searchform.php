...
<input type="text" id="autocomplete" name="query" size="14" value="'.htmlspecialchars(stripslashes(implode(" ", $queries))).'"/>
...
new Ajax.Autocompleter("autocomplete", "autocomplete_choices", "'.XOOPS_URL.'/modules/mysearch/ajax_updater.php", {indicator: \'indicator2\',minChars: 2});
</script>'));
